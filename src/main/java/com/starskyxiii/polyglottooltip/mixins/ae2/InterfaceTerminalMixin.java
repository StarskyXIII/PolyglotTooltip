...
public abstract class InterfaceTerminalMixin {

    @Redirect(
        method = "itemStackMatchesSearchTerm",
        at = @At(
            value = "INVOKE",
        ...
        require = 0,
        remap = false)
    private String polyglot$expandPatternOutputNames(Object stack) {
    ...
    @Redirect(
        ...
        require = 0,
        remap = false)
    private String polyglot$expandInterfaceNameSearch(@Coerce Object entry) {
        return Ae2InterfaceSearchHelper.getSearchableInterfaceName(entry);
    }
